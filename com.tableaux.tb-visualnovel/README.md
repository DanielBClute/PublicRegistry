...
<root>
  ...
  ├── Editor
  │   ├── Dbclutis.TbVisualNovel.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Dbclutis.TbVisualNovel.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Dbclutis.TbVisualNovel.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Dbclutis.TbVisualNovel.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Dbclutis.TbVisualNovel`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package TB Visual Novel Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Dbclutis.TbVisualNovel.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Dbclutis.TbVisualNovel.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Dbclutis.TbVisualNovel.Editor.Tests.asmdef`

  `Tests/Runtime/Dbclutis.TbVisualNovel.Tests.asmdef`
...
Use the `Documentations~/TB Visual Novel.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
